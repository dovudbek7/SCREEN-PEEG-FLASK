...
class Config:
    ...
    # --- スクリーングループ京都滋賀事業所間出張 (2026-08-07 客先提供の規程) ---
    # 規程では, この事業所間の出張は 出張日当・滞在費補助とも支給対象外.
    # ただし顧客マスタに該当拠点が登録されていないため, 出発地/到着地の
    # 文字列で判定する。該当する拠点名をここに列挙する (要 客先確認)。
    # 「SCREEN」単体は他社名にも含まれ得るため入れていない。
    # 実際の拠点名は客先に確認のうえ追加すること。
    screen_kyoto_shiga_places: tuple = (
